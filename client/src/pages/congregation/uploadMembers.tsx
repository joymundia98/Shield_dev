...
// Import Images
import membersTemplate from "../../assets/members_format.png";
      ...
      <div className="Upload-container">
        ...
        <div className="template-preview">
          ...
          <img
            ...
            onClick={() => setZoomSrc(membersTemplate)}
          />
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                ...
                <br />
                <strong>Applies only to Female members</strong>
              </td>
            </tr>
            <tr>
              <td>nrc</td>
...
export default UploadMembersGuide;
