...
// Import Images
import correctTemplate from "../../assets/correct-template.png";
...
const DepartmentsUploadGuide: React.FC = () => {
  ...
  try {
    ...
    setUploadMessage(
      `${res.data.count} rows uploaded successfully to departments table.`
    );
    setFiles([]);
  } catch (error: any) {
    ...
    <div className="parent-upload-container">
      <div className="Upload-container">
        ...
        <div className="notice">
          ...
          <ul>
            <li>
              Use <strong>words separated by spaces</strong>
            </li>
            <li>
              Column names are <strong>case-insensitive</strong>
            </li>
            <li>
              <strong>Do NOT use underscores</strong> (<code>_</code>)
            </li>
          </ul>
          ...
          <br />
          <code>first_name</code>, <code>First_Name</code>
        </div>
        ...
        <div className="template-preview">
          ...
          <img
            ...
            onClick={() => setZoomSrc(correctTemplate)}
          />
          ...
          <div className="carousel-track" ref={trackRef}>
            ...
            <div className="carousel-slide">
              <div className="carousel-left">
                <h3>Step 1: Check Column Names</h3>
                <ul>
                  <li>
                    Ensure column names use <strong>spaces</strong>, not
                    underscores
                  </li>
                  <li>
                    Column names are <strong>case-insensitive</strong>
                  ...
                  <li>
                    Example: <code>First Name</code>
                  </li>
                  <li>
                    Columns should <strong>Match</strong> the acceptable format
                    shown above
                  </li>
                </ul>
              </div>
        ...
        <table>
          ...
          <tbody>
            ...
            <tr>
              <td>Phone</td>
              <td>Phone number (Excel: Number)</td>
            </tr>
            <tr>
              <td>Position</td>
              <td>User role or title</td>
            </tr>
          </tbody>
        </table>
...
export default DepartmentsUploadGuide;
